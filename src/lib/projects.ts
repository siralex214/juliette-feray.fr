...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    title: 'Rouen Point',
    description:
      'Stratégie de communication locale pour Rouen Point — valoriser la ville, ses événements, sa culture et son dynamisme.',
    longDescription:
      'Sed ut perspiciatis unde omnis iste natus error sit voluptatem. Production de visuels percutants et gestion éditoriale pour engager une communauté locale au quotidien.',
    tags: ['Comm. locale', 'Instagram', 'Affiches', 'Événementiel'],
    photos: [
      {
        id: 'r1',
        caption: 'Campagne ville',
